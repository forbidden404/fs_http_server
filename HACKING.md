...
hidden if the `fs_http_server_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `fs_http_server_DEVELOPER_MODE` to the configure
